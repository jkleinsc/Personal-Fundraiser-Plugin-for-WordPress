...
$.validationEngine = {
	...
	buildPrompt : function(caller,promptText,type,ajaxed) {			// ERROR PROMPT CREATION AND DISPLAY WHEN AN ERROR OCCUR
        ...
        if($.validationEngine.settings.errorClass) {
            $(divFormError).addClass($.validationEngine.settings.errorClass);
        }
	...
	submitValidation : function(caller) {					// FORM SUBMIT VALIDATION LOOPING INLINE VALIDATION
		...
		$(caller).find("[class*=validate]").each(function(){
			...
			if(!$(this).is(':hidden') && !$("."+linkTofield).hasClass("ajaxed")){	// DO NOT UPDATE ALREADY AJAXED FIELDS (only happen if no normal errors, don't worry)
